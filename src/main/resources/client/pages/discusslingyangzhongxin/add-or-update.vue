	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`discusslingyangzhongxin`, this.ruleForm.id);
...
//跨表计算判断
				...
				if(crossrefid && crossuserid) {
					...
					let res = await this.$api.list(`discusslingyangzhongxin`, params);
                ...
                //跨表计算
						if(this.ruleForm.id){
							await this.$api.update(`discusslingyangzhongxin`, this.ruleForm);
						}else{
							await this.$api.add(`discusslingyangzhongxin`, this.ruleForm);
						}
						uni.setStorageSync('discusslingyangzhongxinCleanType',true);
