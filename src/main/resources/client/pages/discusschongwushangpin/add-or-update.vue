	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`discusschongwushangpin`, this.ruleForm.id);
...
//跨表计算判断
				...
				if(crossrefid && crossuserid) {
					...
					let res = await this.$api.list(`discusschongwushangpin`, params);
                ...
                //跨表计算
						if(this.ruleForm.id){
							await this.$api.update(`discusschongwushangpin`, this.ruleForm);
						}else{
							await this.$api.add(`discusschongwushangpin`, this.ruleForm);
						}
						uni.setStorageSync('discusschongwushangpinCleanType',true);
