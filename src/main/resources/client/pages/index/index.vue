...
<view class="content">
	<view :style='{"width":"100%","flexWrap":"wrap","background":"#ffffff","display":"flex","height":"100%"}'>
		...
		<!-- 商品推荐 -->
		<view class="listBox recommend" :style='{"width":"100%","margin":"40rpx 0 40rpx 0","background":"#ffffff","order":"1"}'>
			...
			<view class="title" :style='{"width":"calc(100% - 48rpx)","padding":"36rpx 32rpx 0 32rpx","margin":"0 24rpx 24rpx 24rpx","textAlign":"center","background":"url(http://clfile.zggen.cn/20231028/74e78759bf154422b3874986fcd108c1.png) no-repeat center top","height":"auto"}'>
				<view :style='{"padding":"8rpx 60rpx 8rpx 60rpx","color":"#fff","borderRadius":"8rpx","textAlign":"center","background":"#3da742","display":"inline-block","width":"auto","fontSize":"32rpx","lineHeight":"48rpx","minWidth":"300rpx","fontWeight":"500"}'>宠物售卖推荐</view>
			</view>
			...
			<!-- 样式1 -->
			<view class="list-box style1" :style='{"padding":"24rpx 24rpx 24rpx 24rpx","margin":"40rpx 0 0 0","flexWrap":"wrap","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
				<view @tap="onDetailTap('chongwushoumai',product.id)" v-for="(product,index) in chongwushoumailist" :key="index" class="list-item" :style='{"border":"2rpx solid #3da74250","padding":"20rpx","margin":"0 0 32rpx 0","backgroundColor":"#ffffff","borderRadius":"8rpx","textAlign":"center","flexWrap":"wrap","display":"flex","width":"48%","justifyContent":"center","height":"auto"}'>
					<view :style='{"border":"0px solid #cdf6f2","padding":"0px 20rpx 0px 20rpx","margin":"0 0 0px 0","whiteSpace":"nowrap","color":"#333333","textAlign":"center","overflow":"hidden","borderRadius":"40rpx","background":"#ffffff","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","textOverflow":"ellipsis","height":"48rpx","order":"2"}' class="list-item-title ">{{product.chongwumingcheng}}</view>
					<image :style='{"padding":"0 0 0 0","margin":"0 0 12rpx 0","objectFit":"cover","borderRadius":"0px","display":"inline-block","width":"100%","height":"220rpx"}' class="list-item-image" mode="aspectFill" v-if="product.chongwutupian.substring(0,4)=='http'" :src="product.chongwutupian"></image>
					<image :style='{"padding":"0 0 0 0","margin":"0 0 12rpx 0","objectFit":"cover","borderRadius":"0px","display":"inline-block","width":"100%","height":"220rpx"}' class="list-item-image" mode="aspectFill" v-else :src="product.chongwutupian?baseUrl+product.chongwutupian.split(',')[0]:''"></image>
					<view :style='{"border":"0px solid #cdf6f2","padding":"0px 20rpx 0px 20rpx","margin":"0 0 0px 0","whiteSpace":"nowrap","color":"#333333","textAlign":"center","overflow":"hidden","borderRadius":"40rpx","background":"#ffffff","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","textOverflow":"ellipsis","height":"48rpx","order":"2"}' class="list-item-title ">宠物状态:{{product.chongwuzhuangtai}}</view>
					<view :style='{"padding":"4rpx 20rpx 12rpx 20rpx","color":"#ff0000","textAlign":"right","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","fontWeight":"600","order":"3"}' class="list-item-pirce">￥{{product.price}}</view>
				</view>
			</view>
		...
		<view class="listBox recommend" :style='{"width":"100%","margin":"40rpx 0 40rpx 0","background":"#ffffff","order":"1"}'>
			...
			<view class="title" :style='{"width":"calc(100% - 48rpx)","padding":"36rpx 32rpx 0 32rpx","margin":"0 24rpx 24rpx 24rpx","textAlign":"center","background":"url(http://clfile.zggen.cn/20231028/74e78759bf154422b3874986fcd108c1.png) no-repeat center top","height":"auto"}'>
				<view :style='{"padding":"8rpx 60rpx 8rpx 60rpx","color":"#fff","borderRadius":"8rpx","textAlign":"center","background":"#3da742","display":"inline-block","width":"auto","fontSize":"32rpx","lineHeight":"48rpx","minWidth":"300rpx","fontWeight":"500"}'>宠物商品推荐</view>
			</view>
			...
			<!-- 样式1 -->
			<view class="list-box style1" :style='{"padding":"24rpx 24rpx 24rpx 24rpx","margin":"40rpx 0 0 0","flexWrap":"wrap","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
				<view @tap="onDetailTap('chongwushangpin',product.id)" v-for="(product,index) in chongwushangpinlist" :key="index" class="list-item" :style='{"border":"2rpx solid #3da74250","padding":"20rpx","margin":"0 0 32rpx 0","backgroundColor":"#ffffff","borderRadius":"8rpx","textAlign":"center","flexWrap":"wrap","display":"flex","width":"48%","justifyContent":"center","height":"auto"}'>
					<view :style='{"border":"0px solid #cdf6f2","padding":"0px 20rpx 0px 20rpx","margin":"0 0 0px 0","whiteSpace":"nowrap","color":"#333333","textAlign":"center","overflow":"hidden","borderRadius":"40rpx","background":"#ffffff","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","textOverflow":"ellipsis","height":"48rpx","order":"2"}' class="list-item-title ">{{product.shangpinmingcheng}}</view>
					<image :style='{"padding":"0 0 0 0","margin":"0 0 12rpx 0","objectFit":"cover","borderRadius":"0px","display":"inline-block","width":"100%","height":"220rpx"}' class="list-item-image" mode="aspectFill" v-if="product.shangpintupian.substring(0,4)=='http'" :src="product.shangpintupian"></image>
					<image :style='{"padding":"0 0 0 0","margin":"0 0 12rpx 0","objectFit":"cover","borderRadius":"0px","display":"inline-block","width":"100%","height":"220rpx"}' class="list-item-image" mode="aspectFill" v-else :src="product.shangpintupian?baseUrl+product.shangpintupian.split(',')[0]:''"></image>
					<view :style='{"padding":"4rpx 20rpx 12rpx 20rpx","color":"#ff0000","textAlign":"right","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","fontWeight":"600","order":"3"}' class="list-item-pirce">￥{{product.price}}</view>
				</view>
			</view>
		...
		<!-- 商品列表 -->
			...
			<view class="title" :style='{"width":"calc(100% - 48rpx)","padding":"36rpx 32rpx 0 32rpx","margin":"0 24rpx 24rpx 24rpx","textAlign":"center","background":"url(http://clfile.zggen.cn/20231028/74e78759bf154422b3874986fcd108c1.png) no-repeat center top","height":"auto"}'>
				<view :style='{"padding":"12rpx 60rpx 8rpx 60rpx","color":"#fff","borderRadius":"8rpx","background":"#3da742","display":"inline-block","fontSize":"32rpx","lineHeight":"48rpx","minWidth":"300rpx","fontWeight":"500"}'>领养中心</view>
				<text :style='{"width":"100%","margin":"20rpx 0 0 0","fontSize":"28rpx","lineHeight":"48rpx","color":"#666","display":"block"}' @tap="onPageTap('lingyangzhongxin')">查看更多</text>
			</view>
		  ...
		  <view class="list-box style1" :style='{"padding":"24rpx 24rpx 24rpx 24rpx","margin":"0 0 0 0","flexWrap":"wrap","display":"flex","width":"100%","justifyContent":"space-between","height":"auto"}'>
			<view @tap="onDetailTap('lingyangzhongxin',product.id)" v-for="(product,index) in homelingyangzhongxinlist" :key="index" class="list-item" :style='{"border":"2rpx solid #3da74250","boxShadow":"0 0px 0px #cccccc","padding":"20rpx","margin":"0 0 40rpx 0","backgroundColor":"#ffffff","borderRadius":"8rpx","textAlign":"center","flexWrap":"wrap","display":"flex","width":"48%","justifyContent":"center","height":"auto"}'>
			                			  <view :style='{"padding":"0px 20rpx 0px 20rpx","margin":"0 0 20rpx 0","overflow":"hidden","whiteSpace":"nowrap","color":"#333333","borderRadius":"0px","width":"100%","fontSize":"28rpx","lineHeight":"48rpx","textOverflow":"ellipsis","height":"48rpx"}' class="list-item-title ">{{product.chongwumingcheng}}</view>
			  			  			  			                			  			  <image :style='{"padding":"0 0 0 0","margin":"0 0 20rpx 0","objectFit":"cover","borderRadius":"0px","display":"inline-block","width":"100%","height":"200rpx"}' class="list-item-image" mode="aspectFill" v-if="product.chongwutupian.substring(0,4)=='http'" :src="product.chongwutupian"></image>
			  <image :style='{"padding":"0 0 0 0","margin":"0 0 20rpx 0","objectFit":"cover","borderRadius":"0px","display":"inline-block","width":"100%","height":"200rpx"}' class="list-item-image" mode="aspectFill" v-else :src="product.chongwutupian?baseUrl+product.chongwutupian.split(',')[0]:''"></image>
			  			  			                			  			  			                			  			  			                			  			  			                			  			  			                			  			  			                			  			  			                			  <view :style='{"padding":"0px 20rpx 0px 20rpx","margin":"0 0 20rpx 0","overflow":"hidden","whiteSpace":"nowrap","color":"#333333","borderRadius":"0px","width":"100%","fontSize":"28rpx","lineHeight":"48rpx","textOverflow":"ellipsis","height":"48rpx"}' class="list-item-title ">宠物状态:{{product.chongwuzhuangtai}}</view>
			  			  			  			                			  			  			  			</view>
		  </view>
		...
		<!-- 新闻资讯 -->
			...
			<view class="title" :style='{"width":"calc(100% - 48rpx)","padding":"36rpx 32rpx 0 32rpx","margin":"0 24rpx 24rpx 24rpx","textAlign":"center","background":"url(http://clfile.zggen.cn/20231028/74e78759bf154422b3874986fcd108c1.png) no-repeat center top","height":"auto"}'>
				<view :style='{"padding":"8rpx 60rpx 8rpx 60rpx","color":"#fff","borderRadius":"8rpx","background":"#3da742","display":"inline-block","fontSize":"32rpx","lineHeight":"48rpx","minWidth":"300rpx","fontWeight":"500"}'>知识科普</view>
	...
	export default {
		...
		async onShow() {
			...
			if(uni.getStorageSync("userid")) {
				res = await this.$api.recommend2('chongwushoumai', {
                    page: 1,
                    limit: 4
                });
			} else {
				res = await this.$api.recommend('chongwushoumai', {                                              
                    page: 1,
                    limit: 4
                });
			}
			this.chongwushoumailist = res.data.list
			// 推荐信息
			if(uni.getStorageSync("userid")) {
				res = await this.$api.recommend2('chongwushangpin', {
                    page: 1,
                    limit: 4
                });
			} else {
				res = await this.$api.recommend('chongwushangpin', {                                              
                    page: 1,
                    limit: 4
                });
			}
			this.chongwushangpinlist = res.data.list

			res = await this.$api.list('lingyangzhongxin', {
				page: 1,

				limit: 4
			});
			this.homelingyangzhongxinlist = res.data.list
		},
